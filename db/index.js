...
var db = {
  fireRef: new Firebase('https://nexus-bot.firebaseio.com/'),
  ...
  removeChallenge: function(id, matchKey) {
    var userRef = this.fireRef.child('users/' + id);
    return Q.Promise(function(resolve, reject) {
  ...
  saveChallenge: function(userTo, challenge) {
  ...
  updateMatchResult: function(matchKey, match, result, loserId) {
  ...
  updateUsersScores: function(winnerId, loserId) {
    var usersRef = this.fireRef.child('users');
